...
export const appSettings = sqliteTable("app_settings", {
  ...
  localChatEnabled: integer("local_chat_enabled", { mode: "boolean" }).notNull().default(false),
  localChatBaseUrl: text("local_chat_base_url"),
  localChatModel: text("local_chat_model"),
  localChatLabel: text("local_chat_label"),
  ...
  proxyProtocol: text("proxy_protocol", { enum: ["http", "https"] }).notNull().default("http"),
  proxyHost: text("proxy_host"),
  proxyPort: integer("proxy_port"),
  proxyBypassHosts: text("proxy_bypass_hosts"),
